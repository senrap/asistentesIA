 ...
 */
export function mapearBloques(objetos) {
  var bloques = [];
  var vistos = {};
...
export function mapearTarjetas(objetos) {
  return objetos
    .map(function (o, i) {
...
export function mapearEncuentros(objetos) {
  return objetos
    .map(function (o) {
...
export function facilitadorDe(facilitadores, bloque) {
  var general = null;
