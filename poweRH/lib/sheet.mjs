...
export function instanteAR(fecha) {
 ...
 */
export function mapearProgramas(objetos, anioRef) {
  var programas = [];
...
export function mapearBloques(objetos, anioRef) {
  var vistos = {};
...
export function mapearTarjetas(objetos, anioRef) {
  return objetos
    .map(function (o, i) {
...
export function mapearGrabaciones(objetos, anioRef) {
  return objetos
    .map(function (o) {
      var programa = idPrograma(o);
 ...
 */
export function mapearAjustes(objetos) {
  var generales = {};
  var porPrograma = {};
 ...
 */
export function armar(datos, ahora) {
...
export function programaPorId(programas, id) {
  if (!id) return null;
...
export function facilitadorDe(facilitadores, nombre) {
