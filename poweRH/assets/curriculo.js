...
window.CURRICULO = {
  ...
  "bienvenida": {
    ...
    "lead": "Esta página es tu punto de partida. Guardala en favoritos: acá vas a encontrar siempre las grabaciones, el material de cada bloque y los canales para consultar.",
    "nota": "🛋️ Por favor conectate puntual: vamos a ir trabajando de manera escalonada en un mismo proyecto 🧗🏽 y eso ayuda a que podamos aprovechar el tiempo al máximo 💪"
  },
  "antes": [
    {
  ...
  "cierre": {
    ...
    "acciones": [
      {
        ...
        "texto": "Por favor tomate dos minutos para contarnos brevemente tu experiencia y cómo podemos seguir mejorando desde aquí.",
      ...
      },
      {
        ...
        "texto": "En la web quedan disponibles las grabaciones y todos los materiales, junto con los tips y recomendaciones que te acompañarán en tus proyectos.",
    ...
    "certificado": {
      ...
      "texto": "Entrá, hacé click en la pestaña **Certificados** y completá tu mail.",
      ...
      "campos": [
        {
          "etiqueta": "Nombre",
          "valor": "People Analytics con Power BI"
        },
        {
          "etiqueta": "Organización",
          "valor": "Consultora HACHE"
        },
        {
  ...
  "redes": [
    ...
    {
      "emoji": "🤝",
      "titulo": "Conectar con Pablo",
      "bajada": "Sumate a mi red",
