...
function moduloActual(semanas) {
  ...
  global.PPSheet = { urlHoja: urlHoja, parseCsv: parseCsv, aObjetos: aObjetos, normalizarClave: normalizarClave, aISO: aISO, aHora: aHora, aUrl: aUrl, aArchivo: aArchivo, instanteAR: instanteAR, mapearSemanas: mapearSemanas, mapearFacilitadores: mapearFacilitadores, aplicarBloqueo: aplicarBloqueo, moduloActual: moduloActual };
